...
🎓 **Math & Computer Scientist** with a strong foundation in **mathematics, cybersecurity, and full-stack development**.  
Currently enhancing my **backend & fullstack skills** through the **Patika+ Fullstack Java Developer Bootcamp**, focusing on **Java, Spring Boot, SQL, RESTful APIs, and React**.  

💻 **Cybersecurity & Blue Team enthusiast**, holding the **Cisco CyberOps Associate** and **TryHackMe SAL-1** certifications — experienced in secure coding practices and the **software development lifecycle (SDLC)**.  

🏋️‍♂️ With over **10 years of bodybuilding** and experience across various sports disciplines, I bring **discipline, focus, and resilience** to every project I work on.  
